...
func (c *profileServiceClient) GetUserProfile(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserProfileResponse, error) {
...
func (UnimplementedProfileServiceServer) GetUserProfile(context.Context, *UserRequest) (*UserProfileResponse, error) {
...
func _ProfileService_GetUserProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProfileServiceServer).GetUserProfile(ctx, req.(*UserRequest))
	}
